                ...
                <Modal show={isEditing} onClose={cancelEdit}>
                    <div className="p-8 font-sans">
                        <div className="flex items-center justify-between mb-10">
                            <div>
                                <h3 className="text-2xl font-black text-slate-900 tracking-tight uppercase">Edit Task</h3>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">Updating task for <span className="text-slate-900">{currentItem?.user?.name}</span></p>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
                            <div className="space-y-2">
                                ...
                                {errors.date && <p className="text-[10px] font-bold text-red-500 uppercase tracking-tight mt-2 px-1">{errors.date}</p>}
                            </div>
